  ...
  async function handleSignIn() {
    ...
    try {
      const res = await fetch(`/api/auth/zklogin`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ returnUrl: window.location.origin + "/customer" }),
      });
      ...
      <div className="signin-shell">
        ...
        <div className="signin-cards">
          ...
          <a href="/" style={{
            ...
            transition: 'color 0.2s ease', alignSelf: 'flex-start',
          }}
        ...
        <div className="glass" style={{ padding: '48px', textAlign: 'center' }}>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <p style={{ color: 'var(--muted)', fontSize: '14px' }}>Customer sign-in — no wallet required</p>
          </div>
